...
static const char col_gray4[]       = "#D9D9D9";
...
static const char *batteryinfo[] = { "./.config/dwm/currentbattery.sh", NULL };
static const char *time[] = { "./.config/dwm/time.sh", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_b,	   spawn,	   {.v = batteryinfo } },
	...
	{ MODKEY|ShiftMask,		XK_t, 	   spawn,	   {.v = time } },
